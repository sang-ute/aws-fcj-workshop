---
title: "Deploying Lambda function: livenessResultFunction"
date: "`r Sys.Date()`"
weight: 8
chapter: false
pre: " <b> 7.3 </b> "
...
This page describes how to create the **`livenessResultFunction`** Lambda function.  
It is used to retrieve the **Face Liveness Session results** from Amazon Rekognition, perform face matching, and store data in Amazon DynamoDB/S3.
...
At this point, **`livenessResultFunction`** is ready to be integrated for retrieving liveness results, running face matching, and storing data.
